    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function insertLegend() {
            ...
            for (var i = 0; i < entries.length; ++i) {
                ...
                fragments.push(
                    '<td class="legendColorBox"><div style="border:0px solid ' + options.legend.labelBoxBorderColor + ';padding:1px"><div style="width:50px;height:3px;border:0px solid ' + entry.color + ';background-color: '+entry.color+';overflow:hidden"></div></div></td>' +
                    '<td class="legendLabel" style="border: solid 0px #f00">' + entry.label + '</td>'
                );
            }
            ...
            var table = '<table class="smart" style="color:' + options.grid.color + '"><tr><th width=10%>Линия</th><th width=70%>Описание</th><th width=10%>Значение</th><th width=10%>Удалить</th></tr>' + fragments.join("") + '</table>';
        ...
        plot.onMouseMove = function onMouseMovefunc(e) { onMouseMove(e); };
